...
impl Easing {
    ...
    pub fn apply(&self, t: f32) -> f32 {
        ...
        match self {
            ...
            Self::CustomBounce { strength, squash } => custom_bounce(t, *strength, *squash),
        }
    }
}
...
mod tests {
    ...
    fn rough_ease_endpoints() {
        ...
        assert!(
            (e.apply(1.0) - 1.0).abs() < 1e-5,
            "RoughEase(1) should be ~1"
        );
    }
